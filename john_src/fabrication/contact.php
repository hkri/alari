...
<html>
	<head>
		<!-- title -->
		<title>Alari Fabrication | Contact Us</title>
	...
	<body>
		...
		<div class = 'content'>
			<h1 style = 'position: absolute;top: 50%; width: 100%;text-align: center;font-weight: normal;opacity: 0.7'>TODO: PUT "CONTACT US" RELATED STUFF HERE.</h1>
		</div>
