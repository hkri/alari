...
<html>
	<head>
		<!-- title -->
		<title>Alari Fabrication | Plans and Shop Drawings</title>
	...
	<body>
			...
			<div class = 'wrapper'>
				...
				<div class = 'header-navbox'>
					<ul class = 'nav noselect'>
						...
						<a class = 'active'><li>Plans &amp; Shop Drawings</li></a>
		...
		<div class = 'content'>
			<h1 style = 'position: absolute;top: 50%; width: 100%;text-align: center;font-weight: normal;opacity: 0.7'>TODO: PUT "PLANS AND SHOP DRAWINGS" RELATED STUFF HERE.</h1>
		</div>
