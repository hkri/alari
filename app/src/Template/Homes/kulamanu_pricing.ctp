<?php $this->assign('title', 'Alari Homes | 4079 Kulamanu Pricing'); ?>

<style type = 'text/css'>
  .our-story  { padding-right: 30px;        }
  .row-mission{ margin-top: 30px;           }
  .story-image{ margin-top: 30px;           }
  .widebox    { background-color: #26ac85;  }
  .value-text {
  ...
  .breakdown-table, .breakdown-table tr, .breakdown-table td , .breakdown-table th {
...
<div class = 'content'>
  ...
  <div class = 'wrapper index-description-div'>
    ...
    <p>This quantitative pricing analysis was calculated by <a href = 'https://www.linkedin.com/in/hawaiixchg/' target="_blank">Damon Rhys</a> (MPIA degree from University of
