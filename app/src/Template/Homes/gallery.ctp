...
<div class = 'content'>
    ...
    <div class = 'gallery'>
        <div class = 'thumb-wrapper'>
            ...
            <a class = 'thumblink' href = '../res/homes/gallery/render/render1.jpg' rel = 'prettyPhoto[render]' title = 'A rendered model of a house.'>
                <div class = 'gallery-photo'>
                    <div class = 'photothumb' style = 'background-image:url("../res/homes/gallery/render/thumb1.jpg")'></div>
                    <h2>Home Render</h2>
                </div>
            </a>

            <a class = 'thumblink' href = '../res/homes/gallery/render/render2.jpg' rel = 'prettyPhoto[render]' title = 'A rendered model of a house.'>
                <div class = 'gallery-photo'>
                    <div class = 'photothumb' style = 'background-image:url("../res/homes/gallery/render/thumb2.jpg")'></div>
                    <h2>Home Render</h2>
                </div>
            </a>

            <a class = 'thumblink' href = '../res/homes/gallery/render/render3.jpg' rel = 'prettyPhoto[render]' title = 'A rendered model of a house.'>
                <div class = 'gallery-photo'>
                    <div class = 'photothumb' style = 'background-image:url("../res/homes/gallery/render/thumb3.jpg")'></div>
                    <h2>Home Render</h2>
                </div>
            </a>
