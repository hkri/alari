	...
	<body>
		...
		<div class = 'content'>
			...
			<div class = 'listbox'>
				...
				<!-- Section Title in case separation required -->
				<h1 class = 'section-title'>Main House Plans</h1>
				...
				<div class = 'listitem'>
					...
					<a href = 'plans/main_house/preview/preview1.jpg' rel = 'prettyPhoto[main_home]' title = 'Main Home Plan'>
						<div class = 'thumb' style = 'background-image:url("plans/thumb-kulamanu-a000.png")'></div>
					</a>
				...
				<div class = 'listitem'>
					<a href = 'plans/main_house/preview/preview2.jpg' rel = 'prettyPhoto[main_home]' title = 'Main Home Plan'>
						<div class = 'thumb' style = 'background-image:url("plans/thumb-kulamanu-a004.png")'></div>
					</a>
					<h1>A004</h1>
				...
				<div class = 'listitem'>
					<a href = 'plans/main_house/preview/preview3.jpg' rel = 'prettyPhoto[main_home]' title = 'Main Home Plan'>
						<div class = 'thumb' style = 'background-image:url("plans/thumb-kulamanu-a007.png")'></div>
					</a>
					<h1>A007</h1>
					<h6>Kulamanu St., Honolulu</h6>
					<hr />
				...
				<div class = 'listitem'>
					<a href = 'plans/main_house/preview/preview4.jpg' rel = 'prettyPhoto[main_home]' title = 'Main Home Plan'>
						<div class = 'thumb' style = 'background-image:url("plans/thumb-kulamanu-a008.png")'></div>
					</a>
					<h1>A008</h1>
					<h6>Kulamanu St., Honolulu</h6>
					<hr />
				...
				<div class = 'listitem'>
					<a href = 'plans/main_house/preview/preview5.jpg' rel = 'prettyPhoto[main_home]' title = 'Main Home Plan'>
						<div class = 'thumb' style = 'background-image:url("plans/thumb-kulamanu-a009.png")'></div>
					</a>
					<h1>A009</h1>
					<h6>Kulamanu St., Honolulu</h6>
					<hr />
				...
				<div class = 'listitem'>
					<a href = 'plans/main_house/preview/preview6.jpg' rel = 'prettyPhoto[main_home]' title = 'Main Home Plan'>
						<div class = 'thumb' style = 'background-image:url("plans/thumb-kulamanu-a011.png")'></div>
					</a>
					<h1>A011</h1>
					<h6>Kulamanu St., Honolulu</h6>
					<hr />
				...
				<div class = 'listitem'>
					<a href = 'plans/main_house/preview/preview7.jpg' rel = 'prettyPhoto[main_home]' title = 'Main Home Plan'>
						<div class = 'thumb' style = 'background-image:url("plans/thumb-kulamanu-a014.png")'></div>
					</a>
					<h1>A014</h1>
					<h6>Kulamanu St., Honolulu</h6>
					<hr />
				...
				<div class = 'listitem'>
					<a href = 'plans/main_house/preview/preview8.jpg' rel = 'prettyPhoto[main_home]' title = 'Main Home Plan'>
						<div class = 'thumb' style = 'background-image:url("plans/thumb-kulamanu-s002.png")'></div>
					</a>
					<h1>S002</h1>
					<h6>Kulamanu St., Honolulu</h6>
					<hr />
				...
				<div class = 'listitem'>
					<a href = 'plans/accessory_house/preview/preview1.jpg' rel = 'prettyPhoto[acc_home]' title = 'Accessory House Plan'>
						<div class = 'thumb' style = 'background-image:url("plans/thumb-kulamanu-acsry-a002.png")'></div>
					</a>
					<h1>A-2</h1>
					<h6>Kulamanu St., Honolulu</h6>
					<hr />
				...
				<div class = 'listitem'>
					<a href = 'plans/accessory_house/preview/preview2.jpg' rel = 'prettyPhoto[acc_home]' title = 'Accessory House Plan'>
						<div class = 'thumb' style = 'background-image:url("plans/thumb-kulamanu-acsry-a003.png")'></div>
					</a>
					<h1>A-3</h1>
					<h6>Kulamanu St., Honolulu</h6>
					<hr />
				...
				<div class = 'listitem'>
					<a href = 'plans/accessory_house/preview/preview3.jpg' rel = 'prettyPhoto[acc_home]' title = 'Accessory House Plan'>
						<div class = 'thumb' style = 'background-image:url("plans/thumb-kulamanu-acsry-a004.png")'></div>
					</a>
					<h1>A-4</h1>
					<h6>Kulamanu St., Honolulu</h6>
					<hr />
				...
				<div class = 'listitem'>
					<a href = 'plans/accessory_house/preview/preview4.jpg' rel = 'prettyPhoto[acc_home]' title = 'Accessory House Plan'>
						<div class = 'thumb' style = 'background-image:url("plans/thumb-kulamanu-acsry-a006.png")'></div>
					</a>
					<h1>A-6</h1>
					<h6>Kulamanu St., Honolulu</h6>
					<hr />
				...
				<div class = 'listitem'>
					<a href = 'plans/accessory_house/preview/preview5.jpg' rel = 'prettyPhoto[acc_home]' title = 'Accessory House Plan'>
						<div class = 'thumb' style = 'background-image:url("plans/thumb-kulamanu-acsry-s001.png")'></div>
					</a>
					<h1>S-1</h1>
					<h6>Kulamanu St., Honolulu</h6>
					<hr />
				...
				<div class = 'listitem'>
					<a href = 'plans/accessory_house/preview/preview6.jpg' rel = 'prettyPhoto[acc_home]' title = 'Accessory House Plan'>
						<div class = 'thumb' style = 'background-image:url("plans/thumb-kulamanu-acsry-s002.png")'></div>
					</a>
					<h1>S-2</h1>
					<h6>Kulamanu St., Honolulu</h6>
					<hr />
