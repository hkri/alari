	...
	<body>
		...
		<div class = 'content'>
			...
			<div class = 'listbox'>
				...
				<div class = 'listitem'>
					<a href = 'shop_drawings/garage_door/preview/preview1.jpg' rel = 'prettyPhoto[shop-drawing]' title = 'Garage Door'>
						<div class = 'thumb' style = 'background-image:url("shop_drawings/thumb1.png")'></div>
					</a>
				...
				<div class = 'listitem'>
					<a href = 'shop_drawings/garage_door/preview/preview2.jpg' rel = 'prettyPhoto[shop-drawing]' title = 'Bamboo Concept with dimensions.'>
						<div class = 'thumb' style = 'background-image:url("shop_drawings/thumb2.png")'></div>
					</a>
					...
					<div class = 'description'>	 <!-- Plan Description -->
						<p>
							<i>Shop Drawing</i>
							<br />
							1935 Bamboo concept with dimensions.
						</p>
					</div>
					 <!-- To do: updated href to plan PDF link -->
				...
				<div class = 'listitem'>
					<a href = 'shop_drawings/window_joining/preview/preview1.jpg' rel = 'prettyPhoto[shop-drawing]' title = 'Awning Window Sample 1'>
						<div class = 'thumb' style = 'background-image:url("shop_drawings/thumb3.png")'></div>
					</a>
				...
				<div class = 'listitem'>
					<a href = 'shop_drawings/window_joining/preview/preview2.jpg' rel = 'prettyPhoto[shop-drawing]' title = 'Casement window sample'>
					<div class = 'thumb' style = 'background-image:url("shop_drawings/thumb4.png")'></div>
				...
				<div class = 'listitem'>
					<a href = 'shop_drawings/window_joining/preview/preview3.jpg' rel = 'prettyPhoto[main_home]' title = 'Sliding window sample'>
						<div class = 'thumb' style = 'background-image:url("shop_drawings/thumb5.png")'></div>
					</a>
		...
		<script type = 'text/javascript'>
			...
			$doc.ready(function(){
				...
				//check if overflow text in each thumbnail.
				var $itemdesc = $('.listitem p');
				$itemdesc.each(function(index, value){
					if(value.scrollHeight > $(value).innerHeight()){
						$(value).addClass('ellipsis');
					}
				});
